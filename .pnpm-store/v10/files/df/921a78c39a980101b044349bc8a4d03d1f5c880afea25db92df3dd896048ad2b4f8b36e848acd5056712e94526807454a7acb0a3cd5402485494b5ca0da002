//#region src/utils/guardWebKitScrollDuringRebuild.ts
/**
...
*/
function guardWebKitScrollDuringRebuild(pre, rebuild) {
...
//# sourceMappingURL=guardWebKitScrollDuringRebuild.js.map