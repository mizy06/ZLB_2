...
// and WebSocket call (the persistent server token, or the configured server
// password). The Web UI obtains that credential in one of two ways:
//   1. From the URL fragment (`#token=<...>`) appended when the launcher
...
// in the server's data directory and handed to the browser in the launch URL.
