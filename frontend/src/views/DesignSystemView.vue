  ...
  <div class="ds-page">
    ...
    <div class="layout">
      ...
      ui-monospace, "SF Mono", Menlo, Consolas, monospace;</pre></div>
            ...
            <p>Do not use emoji as functional icons. The TopoMind five-node mind-tree mark is a brand asset and is not part of this icon system.</p>
            ...
            <div class="callout info"><span class="ico">i</span><div>
              Under <code>@media (prefers-reduced-motion: reduce)</code>, all animation and transition durations drop to about <code>0.001ms</code> (effectively off). Components should not check this individually; it is handled uniformly in the global styles.
            </div></div>
    ...
    export function auth(token: string) {
      return verify(token, process.env.JWT_SECRET!);
            ...
            <p>Use the shared loader everywhere so loading states stay visually consistent:</p>
            <ul class="clean">
              <li><b>Spinner (plain · SVG ring)</b> —— used for button loading, app startup (GlobalLoading), chat waits, and general inline waits.</li>
            </ul>
          ...
          <section id="rules">
            ...
            <table class="dt">
              ...
              <tbody>
                ...
                <tr><td class="tk">no-emoji-icon</td><td>using emoji as a functional icon; loading states use the shared <code>Spinner</code> component</td><td><span class="pill red">Forbidden</span></td></tr>
            ...
            <h3 class="sub">Loading indicator</h3>
            <div class="callout good"><span class="ico">✓</span><div>
              Loading states use the shared <code>Spinner</code> component. Do not use emoji or bespoke animated marks as functional loading indicators.
            </div></div>
    ...
    /*         sidebar ↑    ↑handle  ↑conversation  ↑handle ↑right panel (auto) */</pre></div>
          ...
          <section id="a11y">
            ...
            <p>Handled uniformly in the global styles per §02's <code>@media (prefers-reduced-motion: reduce)</code>; components do not check this individually.</p>
