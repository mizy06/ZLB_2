...
<template>
  <div class="ds-page">
    ...
    <div class="layout">
      ...
      <aside class="sidebar">
        <div class="brand">
          <div class="brand-mark"><BrandMark class="brand-logo" label="TopoMind" /></div>
          <div class="brand-name">TopoMind</div>
        </div>
        ...
        <div class="content-inner">
          ...
          <section id="overview">
            <div class="hero">
              ...
              <h1>TopoMind <span class="grad">Design System</span></h1>
              <p class="lead">
                This document defines the visual language and component specification for TopoMind — design tokens, component primitives, the chat interface, theming, and style rules.
                All UI work is grounded in it: unified, restrained, token-driven, and themeable.
              </p>
              <div class="hero-meta">
                <span class="meta-chip"><span class="dot"></span> Scope <b>apps/agent</b></span>
          ...
          <section id="principles">
            ...
            <p class="sec-desc">
              Every UI decision traces back to the following principles. TopoMind is a knowledge-structuring agent for study and research: quick scanning, long stretches of focused reading, and clear visual results — the design serves the task and stays restrained, precise, and density-first.
            </p>
            ...
            <div class="callout good">
              <span class="ico">✓</span>
              <div>
                <b>Brand tone (the do-not list)</b>: calm, clinical, never exaggerated. <span class="pill red" style="margin:0 4px">Reject</span> purple gradients, glassmorphism, glowing shadows, AI purple / blue glows, endlessly looping fussy micro-animations, "Boost your productivity"-style marketing copy, and using emoji as icons — <b>the moon phases 🌑…🌘 are the sole exception</b>, used only while waiting for TopoMind to respond. These are all common tells of AI-generated interfaces (an "AI tell"), deliberately avoided.
              </div>
            </div>
          ...
          <section id="tokens">
            ...
            <p>TopoMind uses two font families: <b>--font-ui</b> (UI and body, Inter first) and <b>--font-mono</b> (code and monospace). Components always reference the variables; do not hard-code font names.</p>
      ...
      ui-monospace, "SF Mono", Menlo, Consolas, monospace;</pre></div>
            ...
            <p>Do not use emoji as functional icons (the sole exception is the moon phases 🌑…🌘, used only while waiting for TopoMind to respond). The TopoMind five-node mind-tree mark is a brand asset and is not part of this icon system.</p>
    ...
    <span class="c">// size:    sm | md | lg</span></pre>
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                ...
                <div class="demo-row">
                  ...
                  <span class="p-badge solid">AGENT</span>
                </div>
            ...
            <ul class="clean">
              ...
              <li><b>Attention card</b> —— content that needs a user decision, such as a Question. The head carries an accent color band to stand out from the message stream.</li>
            </ul>
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                <div class="demo-row" style="align-items:flex-start">
                  ...
                  <div class="p-field demo-grow">
                    ...
                    <select class="p-select"><option>Anthropic</option><option>OpenAI</option><option>Provider</option></select>
                  </div>
                </div>
                <div class="p-field">
    ...
    export function auth(token: string) {
      return verify(token, process.env.JWT_SECRET!);
                ...
                <div class="p-dialog">
                  <div class="p-dialog-head">
                    <div>
                      ...
                      <div class="p-dialog-desc">Create an independent TopoMind chat in the current workspace.</div>
                    </div>
            ...
            <ul class="clean">
              ...
              <li><b>MoonSpinner (moon phase · brand signature)</b> —— used <b>only</b> for the chat waiting state of "message sent, waiting for TopoMind's first response" (the sending placeholder in ChatPane, SideChatPanel, ActivityNotice).</li>
            </ul>
            ...
            <h4 class="mini">MoonSpinner · moon phase (only while waiting for TopoMind)</h4>
            <div class="stage-wrap">
            ...
            <div class="callout info"><span class="ico">i</span><div>The moon phase is the <b>sole exception</b> to the emoji-as-icon rule, and is <b>limited</b> to waiting for TopoMind's first response. It is currently implemented twice — in <code>MoonSpinner.vue</code> and <code>ActivityNotice.vue</code> — and should be merged into a single <code>MoonSpinner</code> component, sized via tokens and supporting <code>prefers-reduced-motion</code>. All other loading states use the plain Spinner.</div></div>
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                <div class="p-tabs">
                  ...
                  <span class="p-tab">TopoMind</span>
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                <div class="p-empty" style="width:100%;border:1px dashed var(--p-line);border-radius:var(--p-r-lg)">
                  ...
                  <div class="em-hint">Click "New chat" to start a conversation with TopoMind</div>
                </div>
              </div>
            </div>
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col" style="align-items:center">
                <div class="p-sheet" style="width:100%;max-width:360px">
                  ...
                  <div class="p-menu-item" style="padding:8px 10px">agent-model · thinking</div>
                  <div class="p-menu-item" style="padding:8px 10px">agent-model · instant</div>
                </div>
              </div>
            </div>
          ...
          <section id="chat">
            ...
            <p class="sec-desc">
              The message stream is the core of TopoMind. The goal of the overhaul: have the 5 card types (Agent / Tool / Question / Swarm / Todo)
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                ...
                <span class="stage-label">③ Decision card · heavy (question requiring user input)</span>
                <div class="p-action">
                  <div class="p-action-head"><span class="p-action-title">Choose an output format</span><span class="p-badge info sm" style="margin-left:auto">question</span></div>
                  <div class="p-action-body" style="padding:10px 14px;font-size:13px">Should the result use a compact or detailed layout?</div>
                </div>
              </div>
            </div>
            ...
            <ul class="clean check">
              ...
              <li><b>Only questions keep a full card</b> because they genuinely need the user's attention and response.</li>
            </ul>
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col" style="align-items:center;background:#fff">
                <div class="p-composer" style="width:100%;max-width:620px">
                  <div class="p-composer-ta ph">Message TopoMind, / to run a command, @ to reference a file…</div>
                  <div class="p-composer-bar">
                    ...
                    <div class="p-composer-right">
                      <span class="p-pill"><span class="pp-strong">agent-model</span><span class="pp-sub">· thinking</span><svg class="p-ic" viewBox="0 0 24 24" fill="currentColor"><path fill="currentColor" d="m12 13.171l4.95-4.95l1.414 1.415L12 16L5.636 9.636L7.05 8.222z"/></svg></span>
          ...
          <section id="themes">
            ...
            <p class="sec-desc">
              TopoMind uses <b>one unified theme</b>: the same components, fonts, radii, shadows, and surfaces — "reskinning" only changes colors.
          ...
          <section id="rules">
            ...
            <table class="dt">
              ...
              <tbody>
                ...
                <tr><td class="tk">no-emoji-icon</td><td>using emoji as a functional icon (<b>the moon phases 🌑…🌘 are the sole exception</b>, and only while waiting for TopoMind to respond; all other loading states use the plain Spinner)</td><td><span class="pill amber">Moon phase exempt</span></td></tr>
            ...
            <div class="callout good"><span class="ico">✓</span><div>
              The "🌑…🌘" moon-phase emoji are a TopoMind interaction signature, <b>used only while waiting for TopoMind's first response</b>, and are rendered uniformly by the <code>MoonSpinner</code> component; waiting states such as <code>ActivityNotice</code> reuse it rather than implementing their own moon phase.
            ...
            <div class="footer">
              <span>TopoMind Design System · v1.0</span>
    ...
    /*         sidebar ↑    ↑handle  ↑conversation  ↑handle ↑right panel (auto) */</pre></div>
            ...
            <table class="dt">
              ...
              <tbody>
                ...
                <tr><td>Attention Badge</td><td><code>Badge</code> sm: info (needs answer) / danger (aborted)</td></tr>
          ...
          <section id="a11y">
            ...
            <p class="sec-desc">
              TopoMind is a focused knowledge-work tool; it <b>does not target a specific WCAG conformance level</b>, nor maintain a full screen-reader QA matrix.
