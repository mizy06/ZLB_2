...
function providerLabel(type: string): string {
  return type === 'moonshot' ? t('providers.agentProvider') : type;
}
</script>
      ...
      <div class="prov-list">
        ...
        <template v-else>
          <div v-for="p in providers" :key="p.id" class="prov-row">
            ...
            <div class="prov-info">
              <span class="prov-type">{{ providerLabel(p.type) }}</span>
            ...
            <div class="prov-actions">
              <Tooltip :text="t('providers.refreshTitle', { type: providerLabel(p.type) })">
                <Button variant="secondary" size="sm" @click="emit('refresh', p.id)">{{ t('providers.refresh') }}</Button>
              </Tooltip>
              <Tooltip :text="t('providers.deleteTitle', { type: providerLabel(p.type) })">
          ...
          <div class="add-form">
            <Field :label="t('providers.fieldType')">
              <Select v-model="addForm.type">
                <option v-for="pt in PROVIDER_TYPES" :key="pt" :value="pt">{{ providerLabel(pt) }}</option>
              </Select>
            </Field>
